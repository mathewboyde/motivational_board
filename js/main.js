$(document).ready(function(){
	...
	const arr_german = [
		"Anpassungsfähig", "abenteuerlustig", "liebevoll", "erstaunlich", "künstlerisch",
		"schön", "grenzenlos", "mutig",
		"ruhig", "fähig", "fürsorglich", "klug", "komfortabel", "mitfühlend", "selbstbewusst", "rücksichtsvoll", "mutig", "kreativ",
		"entschlossen", "zielstrebig", "fleißig", "dynamisch",
		"eifrig", "energiegeladen", "unterhaltsam", "enthusiastisch", "überschwänglich", "ausdrucksstark",
		"fabelhaft", "fantastisch", "furchtlos", "freundlich", "witzig",
		"großzügig", "sanft",
		"glücklich", "fleißig", "hilfsbereit", "urkomisch", "ehrlich",
		"fantasievoll", "unabhängig", "intellektuell", "intelligent", "intuitiv", "erfinderisch", "fröhlich",
		"freundlich", "gutherzig", "sachkundig",
		"besonnen", "lebhaft", "beliebt", "liebevoll", "loyal",
		"bescheiden",
		"optimistisch", "kontaktfreudig",
		"leidenschaftlich", "geduldig", "beharrlich", "höflich", "praktisch", "hübsch", "proaktiv", "produktiv",
		"schlagfertig",
		"rational", "aufgeschlossen", "zuverlässig", "einfallsreich", "verantwortungsbewusst",
		"vernünftig", "sensibel", "geschickt", "klug", "direkt", "stark", "erfolgreich",
		"nachdenklich", "vertrauenswürdig",
		"verständnisvoll",
		"vielseitig", "lebhaft",
		"herzlich", "bereit", "weise", "witzig", "wunderbar"
	];
	var lang_type = "english";
	var num_of_messages = 20;
	class main_engine {
		constructor() {
		...
		prepare_statements() {
			...
			switch(lang_type) {
				...
				case "german": use_arr = arr_german; 	prep_text = "Du bist ";	break;
			}
			for(let z = 0; z < use_arr.length; z++) {
				this.statements.push(prep_text + use_arr[z]);
			}
			for(let z = 0; z < num_of_messages; z++) {
		...
		set_draw_data(t, s) {
			this.ctx.font = "" + font_sizes[s] + "px Reenie Beanie";
